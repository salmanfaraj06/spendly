...
## Acceptance criteria
- [x] 6 facts computed correctly from representative inputs
- [x] Edge cases: no previous cycle, zero budget, negative net, empty data
- [x] Pure (no I/O, no AI); unit-tested (Vitest)
